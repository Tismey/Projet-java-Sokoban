        ...
        this.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                if (e.getKeyCode() != KeyEvent.VK_DOWN && e.getKeyCode() != KeyEvent.VK_UP
                    ...
                    System.out.println(
                            "Mauvaise touche pressée, les mouvements se font avec les touches directionnelles.");
            };
            ...
            public void keyPressed(KeyEvent e) {
                ...
                switch (e.getKeyCode()) {
                    case KeyEvent.VK_LEFT:
                        ...
                        numRes = univ.getLevelPockableMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                Direction.GAUCHE, univ.getUnivers().get(playerWorld),
                                univ.getUnivers().get(playerWorld), resC);
                        /* S'il est valable alors on essaye de faire un mouvement avec poussette */
                        if (numRes >= 0) {
                            if ((numMove = univ.getNumPockableMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                    Direction.GAUCHE, univ.getUnivers().get(playerWorld),
                                    univ.getUnivers().get(playerWorld), initMove)) > 0)
                                univ.pockableMove(resC, Direction.GAUCHE, univ.getUnivers().get(numRes), numMove);
                        }
                        /* Mouvement pour un joueur monde */
                        else if (univ.getUnivers().get(playerWorld).playerIsAWorld()
                                && univ.checkMovePossible(univ.getUnivers().get(playerWorld).playerSpawn(),
                                        Direction.GAUCHE, univ.getUnivers().get(playerWorld))) {
                            numMove = univ.getNumMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                    Direction.GAUCHE, univ.getUnivers().get(playerWorld), initMove);
                            univ.playerWorldMove(univ.getUnivers().get(playerWorld).playerSpawn(), Direction.GAUCHE,
                                    univ.getUnivers().get(playerWorld), numMove);
                        }
                        /* Mouvement pour un joueur simple */
                        else if (univ.checkMovePossible(univ.getUnivers().get(playerWorld).playerSpawn(),
                                Direction.GAUCHE, univ.getUnivers().get(playerWorld))) {
                            numMove = univ.getNumMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                    Direction.GAUCHE, univ.getUnivers().get(playerWorld), initMove);
                    ...
                    case KeyEvent.VK_RIGHT:
                        /* On récupére un numéro de monde */
                        numRes = univ.getLevelPockableMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                Direction.DROITE, univ.getUnivers().get(playerWorld),
                                univ.getUnivers().get(playerWorld), resC);
                        /* S'il est valable alors on essaye de faire un mouvement avec poussette */
                        if (numRes >= 0) {
                            if ((numMove = univ.getNumPockableMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                        ...
                        /* Mouvement pour un joueur monde */
                                ...
                                && univ.checkMovePossible(univ.getUnivers().get(playerWorld).playerSpawn(),
                                        Direction.DROITE, univ.getUnivers().get(playerWorld))) {
                            numMove = univ.getNumMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                    Direction.DROITE, univ.getUnivers().get(playerWorld), initMove);
                            univ.playerWorldMove(univ.getUnivers().get(playerWorld).playerSpawn(), Direction.DROITE,
                                    univ.getUnivers().get(playerWorld), numMove);
                        }
                        /* Mouvement pour un joueur simple */
                        else if (univ.checkMovePossible(univ.getUnivers().get(playerWorld).playerSpawn(),
                    ...
                    case KeyEvent.VK_UP:
                        /* On récupére un numéro de monde */
                        numRes = univ.getLevelPockableMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                Direction.HAUT, univ.getUnivers().get(playerWorld), univ.getUnivers().get(playerWorld),
                                resC);
                        /* S'il est valable alors on essaye de faire un mouvement avec poussette */
                        if (numRes >= 0) {
                            if ((numMove = univ.getNumPockableMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                    Direction.HAUT, univ.getUnivers().get(playerWorld),
                                    univ.getUnivers().get(playerWorld), initMove)) > 0)
                        ...
                        /* Mouvement pour un joueur monde */
                            ...
                            univ.playerWorldMove(univ.getUnivers().get(playerWorld).playerSpawn(), Direction.HAUT,
                                    univ.getUnivers().get(playerWorld), numMove);
                        }
                        /* Mouvement pour un joueur simple */
                        else if (univ.checkMovePossible(univ.getUnivers().get(playerWorld).playerSpawn(),
                    ...
                    case KeyEvent.VK_DOWN:
                        /* On récupére un numéro de monde */
                        numRes = univ.getLevelPockableMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                Direction.BAS, univ.getUnivers().get(playerWorld), univ.getUnivers().get(playerWorld),
                                resC);
                        /* S'il est valable alors on essaye de faire un mouvement avec poussette */
                        if (numRes >= 0) {
                            if ((numMove = univ.getNumPockableMove(univ.getUnivers().get(playerWorld).playerSpawn(),
                                    Direction.BAS, univ.getUnivers().get(playerWorld),
                                    univ.getUnivers().get(playerWorld), initMove)) > 0)
                        ...
                        /* Mouvement pour un joueur monde */
                            ...
                            numMove = univ.getNumMove(univ.getUnivers().get(playerWorld).playerSpawn(), Direction.BAS,
                                    univ.getUnivers().get(playerWorld), initMove);
                            univ.playerWorldMove(univ.getUnivers().get(playerWorld).playerSpawn(), Direction.BAS,
                                    univ.getUnivers().get(playerWorld), numMove);
                        }
                        /* Mouvement pour un joueur simple */
                        else if (univ.checkMovePossible(univ.getUnivers().get(playerWorld).playerSpawn(), Direction.BAS,
